...
import {Breadcrumb, BreadcrumbItem, Button, Label, Col, Row, Modal, ModalHeader} from 'reactstrap';
...
class Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        this.props.postFeedback(values.firstname,values.firstname, values.telnum, values.email, values.agree, values.contactType,values.message);
